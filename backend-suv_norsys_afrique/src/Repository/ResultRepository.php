...
class ResultRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function findActiviteByVote()
    {
        return $this->createQueryBuilder('t')
        ->select(array('IDENTITY(t.activite) as activite',
                     'count(nullif(t.vote, 0)) as TotaYes',
                     'count(nullif(t.vote, 1)) as TotaNo',
                     ))
        ->groupBy('t.activite')
        ->having('TotaYes >= (TotaNo+TotaYes)*0.75')
        ->getQuery()
        ->getResult()
        ;
    }
